                ...
                <div className="text-gray-500 wysiwyg-content">
                  ...
                  <ul className="list-disc pl-6">
                    <li>
                      ...
                      upgrade is free to all players: Our most advanced, with
                      1:1 tracking, 400-plus ips, and 100 - 25,600 max dpi
                      sensitivity plus zero smoothing, filtering, or
                      acceleration
                    </li>
                    <li>
                    ...
                    <li>
                      ...
                      Customize lighting from nearly 16.8 million colors to
                      match your teams colors, sport your own or sync colors
                      with other Logitech G gear
                    </li>
                    <li>
                      Mechanical switch button tensioning: Metal spring
                      tensioning system and pivot hinges are built into left and
                      right gaming mouse buttons for a crisp, clean click feel
                      with rapid click feedback
                    </li>
                  </ul>
                </div>
