  ...
  return (
    <>
      <div className="px-3">
        ...
        <div className="flex">
          <div className="border rounded-lg border-orange-500 w-32 p-5 dark:bg-gray-800 mx-5">
            <div>
              <img
            ...
            <div className="flex items-center space-x-3">
              ...
              <button className="bg-orange-400 hover:bg-orange-500 text-white font-bold p-1 rounded">
                Follow
              </button>
            </div>
          </div>
