...
const AboutPage = () => {
  return (
    <div>
      <div>
        <h1 className="text-5xl text-center pt-4">About us</h1>
      </div>
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-5/12 ">
              <div className="mt-10 lg:mt-0">
                ...
                <h2 className="mb-5 text-3xl font-bold text-dark dark:text-white sm:text-[40px]/[48px]">
                  Make your customers happy by giving best product.
                </h2>
                ...
                <a
                  ...
                  className="inline-flex items-center justify-center rounded-md border border-transparent bg-primary px-7 bg-orange-500 py-3 text-center text-base font-medium text-white hover:bg-opacity-90"
                >
                  Get Started
                </a>
              </div>
